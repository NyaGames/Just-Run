var playState = function(Just_run){
	...
	playState.prototype.rightInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.upInputIsActive = function(duration) {
	    var isActive = false;
	...
	playState.prototype.upInputReleased = function() {
	    var released = false;
	...
	//control con WASD
	playState.prototype.AInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.DInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.WInputIsActive = function(duration) {
	    var isActive = false;
	...
	playState.prototype.WInputReleased = function() {
	    var released = false;
	...
	playState.prototype.spaceInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.QInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.EInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.RInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.ControlInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.ShiftInputIsActive = function() {
	    var isActive = false;
	...
	playState.prototype.watertrap = function(){
		this.water.destroy();
	...
	playState.prototype.releasew = function(){
		this.wtrap.destroy();
	...
	playState.prototype.releasei = function(){
		this.itrap.destroy();
	...
	playState.prototype.ballrelease = function(){
		this.bola.destroy();
		this.bola = this.game.add.sprite(1100, 367, 'snowball');
	    var rodar = this.bola.animations.add('rodar');
	    this.game.physics.enable(this.bola, Phaser.Physics.ARCADE);
	...
	playState.prototype.srelease = function(){
		this.chuzo1.destroy();
		this.chuzo2.destroy();
		this.chuzo1 = this.game.add.sprite(650, -90, 'chuzo');
	    this.game.physics.enable(this.chuzo1, Phaser.Physics.ARCADE);
	...
	playState.prototype.prelease = function(){
		this.p1.destroy();
		this.p2.destroy();
		this.p3.destroy();
		this.p1 = this.game.add.sprite(-50,70, 'pinguino');
